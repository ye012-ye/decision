 ...
 */
@Service
public class McpSqlExecutorService {

    private static final Logger log = LoggerFactory.getLogger(McpSqlExecutorService.class);

    private final DataSource dataSource;
    private final McpProperties mcpProperties;

    public McpSqlExecutorService(DataSource dataSource, McpProperties mcpProperties) {
